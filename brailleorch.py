...
class BrailleOrchFrame(wx.Frame):
	def __init__(self):
		...
		viewMenu.Append(304, "&Black on white")
		viewMenu.Append(305, "&White on black")
		viewMenu.Append(306, "&Blue on black")
		viewMenu.Append(307, "&Green on black")
		...
		playbackMenu.Append(805, "Play metronome (default unchecked)")
		...
		announceMenu.AppendRadioItem(942, "Braille and objects (default)")
